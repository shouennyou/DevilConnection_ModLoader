...
function registerIPCHandlers(ipcMain, deps = {}) {
	...
	// GetModLoaderPackageInfo: 通过模块自身路径读取包元数据, 兼容开发与打包环境
