...
function zipFiles(sourceDir, zipPath, filter) {
	...
	if (count > 0) zip.writeZip(zipPath);
	return count;
}
...
const Env = {
	...
	getDataPath() {
		return getWritableDataPath(this.getResourcesPath(), undefined, originalFs);
	},
